...
export async function createNestApp(
  ...
  console.log('[boot] 2 app cree (NestFactory.create OK)');
  ...
  console.log('[boot] 3 middlewares/pipes/logger OK (avant Swagger)');
  ...
  console.log('[boot] 4 createNestApp termine (retour app)');
  return app;
}
